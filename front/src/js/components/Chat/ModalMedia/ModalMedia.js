...
export default class ModalMedia {
  ...
  drawUi() {
    const heading = createElement('h4', {
      textContent: messages.ERROR_GOING_WRONG,
    });
    const paragraph1 = createElement('p', {
      textContent: messages.ERROR_MEDIA_PERMISSION,
    });
    const paragraph2 = createElement('p', {
      textContent: messages.LABEL_MEDIA,
    });
    ...
    const modalContent = createElement('div', {
      ...
      children: [heading, paragraph1, paragraph2, btnWrapper],
    });
